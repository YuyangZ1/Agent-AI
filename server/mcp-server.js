...
server.registerTool(
  ...
  {
    description:
      "Search the web using SerpAPI. Returns search result including organic results, snippets, and related information.",
    inputSchema: {
      query: z.string().describe("The search query to excute"),
      num: z
        .number()
        .optional()
