...
// Absolute path to the MCP server file (will be spawned as a child process)
...
const chatMCP = async (query) => {
  ...
  try {
    //Ensure client is connected (reuse excisting connections)
    ...
    //Use the LLM to answer the question based on search result
    ...
    const formattedPrompt = await prompt.format({
      searchResults: searchResults || "No such results available",
    });
